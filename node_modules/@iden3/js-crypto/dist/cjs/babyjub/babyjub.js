...
class BabyJub {
    constructor(F) {
        this.F = F;
        this.p = ff_1.Scalar.fromString('21888242871839275222246405745257275088548364400416034343698204186575808495617');
        this.pm1d2 = ff_1.Scalar.div(ff_1.Scalar.sub(this.p, ff_1.Scalar.e(1)), ff_1.Scalar.e(2));
        this.Generator = [
        ...
        this.order = ff_1.Scalar.fromString('21888242871839275222246405745257275088614511777268538073601725287587578984328');
        this.subOrder = ff_1.Scalar.shiftRight(this.order, 3);
        this.A = F.e('168700');
        this.D = F.e('168696');
    }
    addPoint(a, b) {
    ...
    mulPointEscalar(base, e) {
        ...
        while (!ff_1.Scalar.isZero(rem)) {
            ...
            rem = ff_1.Scalar.shiftRight(rem, 1);
        }
        return res;
    }
    inSubgroup(P) {
