                ...
                return function (input, meta, explore) {
                    ...
                    try {
                        for (var _c = __values(meta.tuples.filter(function (t) {
                            return t.elements.some(function (e) { var _a; return filter((_a = e.rest) !== null && _a !== void 0 ? _a : e); });
                    ...
                    if (meta.arrays.filter(function (a) { return filter(a.value); }).length)
                        unions.push({
                            type: "array",
    ...
    var filter = function (meta) {
        return meta.any === false &&
            (meta.objects.length !== 0 ||
                ...
                meta.arrays.some(function (e) { return filter(e.value); }));
    };
    var PREFIX = "$p";
...
})(PruneProgrammer || (exports.PruneProgrammer = PruneProgrammer = {}));
