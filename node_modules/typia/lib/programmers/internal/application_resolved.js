...
exports.application_resolved = void 0;
var application_schema_1 = require("./application_schema");
var application_resolved = function (options) {
...
exports.application_resolved = application_resolved;
...
var is_date = function (visited) {
    return function (meta) {
        ...
        return (meta.natives.some(function (name) { return name === "Date"; }) ||
            meta.arrays.some(function (array) { return is_date(visited)(array.value); }) ||
            meta.tuples.some(function (tuple) {
                return tuple.elements.some(is_date(visited));
            }) ||
