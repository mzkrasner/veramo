...
var check_union_array_like = function (accessor) {
    return function (props) {
        return function (parameters) {
            return function (input, origins, explore, tags, jsDocTags) {
                var targets = origins.map(accessor.transform);
                if (targets.length === 1)
                    return typescript_1.default.factory.createArrowFunction(undefined, undefined, parameters, undefined, undefined, props.decoder(accessor.array(input), targets[0], explore, tags, jsDocTags));
                ...
                var predicate = function (meta) {
                    return typescript_1.default.factory.createArrayLiteralExpression([
                        typescript_1.default.factory.createArrowFunction(undefined, undefined, [
                            IdentifierFactory_1.IdentifierFactory.parameter("top", meta instanceof MetadataArray_1.MetadataArray
                                ? TypeFactory_1.TypeFactory.keyword("any")
                                : typescript_1.default.factory.createTypeReferenceNode("any[]")),
                        ], TypeFactory_1.TypeFactory.keyword("any"), undefined, props.checker(typescript_1.default.factory.createIdentifier("top"), accessor.element(meta), __assign(__assign({}, explore), { tracable: false, postfix: meta instanceof MetadataArray_1.MetadataArray
                                ? "\"[0]\""
                        ...
                        ], TypeFactory_1.TypeFactory.keyword("any"), undefined, props.decoder(typescript_1.default.factory.createIdentifier("entire"), meta, __assign(__assign({}, explore), { tracable: true }), tags, jsDocTags)),
                    ], true);
                };
