        ...
        return function (config) {
            return function (importer) {
                return function (input, meta, explore) {
                    ...
                    if (meta.any ||
                        meta.arrays.some(function (a) { return a.value.any; }) ||
                        meta.tuples.some(function (t) { return t.elements.every(function (e) { return e.any; }); }))
                    ...
                    if (meta.resolved !== null)
                        unions.push({
                            ...
                            value: function () {
                                return decode_to_json(project)(config)(importer)(input, meta.resolved.returns, explore);
                            },
                        });
...
})(CloneProgrammer || (exports.CloneProgrammer = CloneProgrammer = {}));
