...
var iterate_metadata_native = function (checker) {
    return function (meta, type) {
        ...
        var complicate = COMPLICATES.get(name);
        if (complicate && validator(complicate)) {
            ArrayUtil_1.ArrayUtil.set(meta.natives, (_b = complicate.name) !== null && _b !== void 0 ? _b : name, function (str) { return str; });
            return true;
        }
        try {
            for (var GENERICS_1 = __values(GENERICS), GENERICS_1_1 = GENERICS_1.next(); !GENERICS_1_1.done; GENERICS_1_1 = GENERICS_1.next()) {
                ...
                if (name.substring(0, generic.name.length) === generic.name &&
                    validator(generic)) {
                    ArrayUtil_1.ArrayUtil.set(meta.natives, (_c = generic.name) !== null && _c !== void 0 ? _c : name, function (str) { return str; });
                    return true;
                }
            }
        }
