    ...
    return function (array) {
        return function (meta) {
            if (visited.has(meta))
                return false;
            visited.add(meta);
            return (meta.arrays.some(function (a) { return a === array || isArrayRecursive(visited)(array)(a.value); }) ||
                meta.aliases.some(function (alias) {
                    return isArrayRecursive(visited)(array)(alias.value);
                }) ||
                meta.tuples.some(function (t) {
                    return !t.recursive &&
                        t.elements.some(function (e) { return isArrayRecursive(visited)(array)(e); });
                }) ||
    ...
    return function (tuple) {
        return function (meta) {
            ...
            return (meta.tuples.some(function (t) {
                return t === tuple ||
                    t.elements.some(function (e) { return isTupleRecursive(visited)(tuple)(e); });
            }) ||
                meta.arrays.some(function (a) {
                    return !a.recursive && isTupleRecursive(visited)(tuple)(a.value);
                }) ||
            ...
            return (meta.objects.some(function (o) {
                ...
                meta.tuples.some(function (tuple) {
                    return !tuple.recursive &&
                        tuple.elements.some(function (elem) {
